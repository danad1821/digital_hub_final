...
export default function LocationsPageEditor() {
      ...
      {isLoading ? (
        ...
        <form onSubmit={handleSave} className="space-y-12">
          <section className={CardStyle}>
            <h2 className={SectionHeaderStyle}>Locations Section</h2>
        ...
        <div className="text-center p-12 text-lg text-red-400">
          Failed to load Locations page data. Please check the console for
          errors.
        </div>
      )}
    </div>
