            ...
            {services.map((service, index) => {
              ...
              return (
                <button
                  ...
                  className={`
                    px-6 py-3 rounded-xl font-semibold text-base transition-all duration-300 shadow-sm
                    ${
                      isActive
                        ? "bg-[#FF8C00] text-[#0A1C30] scale-105 shadow-md ring-2 ring-[#0A1C30] ring-offset-2"
              ...
              {activeService.items.map((item, index) => {
                return (
                  <div
                    key={index}
                    className={`
                      p-8 rounded-xl shadow-lg transition-transform duration-300 hover:-translate-y-1 flex flex-col justify-center
                      bg-[#0A1C30] text-white
                    `}
                  >
                    <h3 className="text-2xl font-bold mb-3 flex items-center">
                      <ArrowRight className={`w-6 h-6 mr-3 text-[#FF6B00]}`} />
                      {item.name}
                    </h3>
