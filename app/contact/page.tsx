        ...
        <main className="container mx-auto px-4">
            ...
            <section className="flex flex-col md:flex-row gap-12 lg:gap-20 py-8">
                ...
                <div className="flex-1 min-w-0 space-y-10">
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold mb-3">Alta Maritime - Head Office</h2>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold mb-3">Alta Maritime - Algeria</h2>
                        <address className="not-italic text-lg space-y-1">
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold mb-3">chartering@altamaritime.com</h2>
                    </div>
                </div>
            </section>
        </main>
